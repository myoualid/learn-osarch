...
(14, 'Bien débuter avec Freecad [FR]', 'Bien débuter avec Freecad [FR]', 12, 14, 'https://www.youtube.com/playlist?list=PL1P4z1vfrsq8KZ2mHqRBZg8aoftq_w6vY', 1, 0),
...
(28, 'Tutoriel QGIS - les bases [fFR', 'Voici un petit tutoriel QGIS vous invitant à vous lancer dans ce SIG.\r\n\r\nNous allons réaliser diverses actions afin de créer une carte thématique pour la protection civile du district de Aigle.', 21, 34, 'https://www.youtube.com/watch?v=-ApmqwJQVME', 1, 0),
...
(41, 'OpenProject Produktdemo DE', 'Lernen Sie traditionelles und agiles Projektmanagement mit OpenProject in diesem detaillierten Einführungsvideo.', 33, 126, 'https://www.youtube.com/channel/UCpDojas1X9ccix4mxadabpw', 1, 0),
...
(33, 'OpenStreetMap', 'OpenStreetMaps is a community built map of the world, powering map data about roads, trails, cafés, railway stations, and much more, on thousands of web sites, mobile apps, and hardware devices.', 2, 'Icon_openstreetmap_64x64.png', 'https://openstreetmap.org/'),
